...
#define AI_NETWORK_MODEL_SIGNATURE     "0x66cbbee550fe36a20836f61d917df399"
...
#define AI_TOOLS_DATE_TIME   "2026-04-24T16:49:50+0200"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 300, 16, 1, 1), AI_STRIDE_INIT(4, 4, 1200, 19200, 19200),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 19952, 1, 1),
    19952, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1264, 1, 1),
    1264, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    gemm_4_output_array.data = AI_PTR(g_network_activations_map[0] + 1200);
    gemm_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1200);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 64);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
    ...
    gemm_6_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    gemm_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 19200);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 19200);
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 19264);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 19264);
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 19776);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 19776);
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 19808);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 19808);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 19936);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 19936);
    return true;
  }
